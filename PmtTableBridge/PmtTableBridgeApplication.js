Ext.namespace("PmtTableBridge");

PmtTableBridge.application = {
  init:function(){
    storeUserProcess = function (n, r, i) {
      ...
      Ext.Ajax.request({
        url: "PmtTableBridgeApplicationAjax",
        method: "POST",
...
Ext.onReady(PmtTableBridge.application.init, PmtTableBridge.application);